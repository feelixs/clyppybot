...
import time
import traceback
from bot.classes import BaseClip, upload_video, DownloadResponse, get_video_details, ClipFailure, is_discord_compatible
    ...
    async def get_m3u8_url(self) -> Tuple[str, str]:
        ...
        try:
            ...
            try:
                ...
                self.logger.info(f"Could not find title of kick clip, using default value")
